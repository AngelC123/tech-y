import { getPurchaseDetails } from "@/app/actions/bodegero"
...
export default async function PurchaseDetailPage({ params }: { params: { id: string } }) {
  const { details, purchase, error } = await getPurchaseDetails(params.id)
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center">
          ...
          <h1 className="text-3xl font-bold tracking-tight">Detalle de Compra</h1>
        </div>
